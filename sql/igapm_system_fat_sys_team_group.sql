...
--
-- Table structure for table `sys_team_group`
--

DROP TABLE IF EXISTS `sys_team_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sys_team_group` (
  `id` bigint NOT NULL COMMENT '',
  `team_group_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '',
...
--
-- Dumping data for table `sys_team_group`
--

LOCK TABLES `sys_team_group` WRITE;
/*!40000 ALTER TABLE `sys_team_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_team_group` ENABLE KEYS */;
UNLOCK TABLES;
