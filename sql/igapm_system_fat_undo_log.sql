...
CREATE TABLE `undo_log` (
  ...
  `xid` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '',
  `context` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '',
  `rollback_info` longblob NOT NULL COMMENT '',
  `log_status` int NOT NULL COMMENT '',
